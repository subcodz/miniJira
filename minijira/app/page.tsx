import { EmailSignInButton } from "@/components/auth/email-signin-button";
  ...
  return (
    <div className="min-h-screen w-full font-sans selection:bg-green-500 selection:text-black  dark:bg-black relative">
      ...
      <div className="fixed top-5 left-4 xs:top-6 xs:left-6 sm:top-8 sm:left-8 z-50 flex items-center gap-2">
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="10" viewBox="0 0 78 30" fill="none">
      ...
      <div className="flex flex-col sm:flex-row min-h-screen">
        ...
        {/* ── SHOWCASE PANEL — short banner on mobile, full right column on desktop ── */}
        <div className="
          order-1 sm:order-2
          w-full sm:w-[55%] lg:w-[60%]
          h-[200px] xs:h-[220px] sm:h-auto sm:min-h-screen
          bg-gray-950 sm:border-l border-b sm:border-b-0 border-gray-800/60
        ...
        ">
          ...
          {/* Placeholder content — swap with carousel */}
          <div className="flex flex-col items-center justify-center gap-3 sm:gap-6 opacity-25">
            <img src="/pic1.png"  className="w-full h-full object-cover" />
          </div>
        </div>
        ...
        <div className="
          ...
          flex-1 sm:min-h-screen
          px-5 xs:px-7 sm:px-10 lg:px-14
          pt-8 pb-12 sm:py-0
        ">
          <div className="w-full max-w-[340px] xs:max-w-[370px] sm:max-w-[380px] flex flex-col items-start">

            <h1 className="text-gray-400 font-mono text-[18px] xs:text-[20px] sm:text-3xl text-left mb-1">
              Welcome to
            </h1>
